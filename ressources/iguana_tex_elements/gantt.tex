...
\begin{ganttchart}[
    ...
    bar label node/.append style={left=2.5cm, align=left},
    bar/.append style={
      draw=primaryblue!80,
      fill=primaryblue!70,
      line width=0.8pt,
    ...
    milestone label node/.append style={left=2.5cm, align=left},
  ...
  \ganttgroup{Lukas}{2025-03-22}{2025-07-04} \\
